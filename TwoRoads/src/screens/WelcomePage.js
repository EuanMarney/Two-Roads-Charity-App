  ...
  return (
    <View style={stylesheet.container}>
      ...
      <TouchableOpacity
        ...
        <TouchableOpacity
          style={[stylesheet.button, {backgroundColor: 'white', borderColor: '#3498db', borderWidth: 2}]} // borderWidth should be a number, not a string
          onPress={() => {
            Alert.alert(
              "Confirm New Account",
      ...
      <Text style={[stylesheet.buttonText, {color: "#3498db"}]}>Register</Text>
